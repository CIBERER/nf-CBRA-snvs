...
ch_known_snps = params.known_snps            ? Channel.fromPath(params.known_snps).collect()              : Channel.value([])
ch_known_snps_tbi = params.known_snps_tbi ? Channel.fromPath(params.known_snps_tbi) : Channel.empty()
